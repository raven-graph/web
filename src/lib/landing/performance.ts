// Real performance track record for Fig. 2.
// Derived from design_handoff_landing_page/data/ravengraph_vs_sp500.csv
// (94 trading days, 2026-02-05 → 2026-06-19), cumulative-return columns
// rounded to 2dp. RavenGraph ends +37.8%, S&P 500 ends +10.8%, spread ≈ +27pp.
...
const rg = [
  ...
  7.07, 7.11, 7.99, 8.58, 8.57, 9.21, 8.95, 9.24, 9.61, 8.97, 9.82, 7.95,
  7.77, 11.15, 14.59, 14.62, 15.11, 14.12, 12.84, 12.62, 11.88, 10.47, 9.11,
  8.77, 9.01, 7.33, 7.23, 7.43, 5.34, 4.76, 2.63, 3.57, 2.63, 3.12, 5.15,
  6.72, 6.72, 10.03, 14.79, 13.66, 17.91, 18.61, 16.69, 18.93, 19.86, 17.93,
  17.46, 17.31, 21.15, 22.78, 25.81, 31.58, 30.34, 32.5, 34.99, 36.58, 37.79,
  44.36, 43.06, 32.36, 36.22, 33.4, 30.44, 36.39, 32.56, 37.1, 32.85, 33.71,
  37.8,
];
...
const ndx = [
  ...
  9.1, 7.4, 9.19, 9.78, 9.78, 11.1, 9.69, 10.82, 10.82,
];
